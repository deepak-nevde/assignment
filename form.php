                        ...
                        <form action="" id="issue_creation" method="post" class="form-horizontal form-label-left" enctype="multipart/form-data">  
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-9 col-sm-9 col-xs-12">
                                <input type="text" id="issue-subject" name="subject" class="form-control" placeholder="Subject">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-9 col-sm-9 col-xs-12">
                                  <textarea class="form-control" id="issue-description" name="description" rows="3" placeholder="Description"></textarea>
                              </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="file" id="issue-image" name="image" multiple class="form-control" placeholder="Images">
                                </div>
                              </div>
                            <div class="form-group">
                              <label class="control-label col-md-3 col-sm-3 col-xs-12">Reviewer Comments</label>
                              <div class="col-md-9 col-sm-9 col-xs-12">
                                  <textarea id="rev_comment" class="form-control" name="reviewer_comment " rows="3" placeholder="Reviwer Comments"></textarea>
                              </div>
                            </div>
...
+                                <button type="button" id="btn-reset" class="btn btn-primary" >Reset</button>
    ...
    <script>
        ...
        $("#rev_comment, #issue-description" ).val(' ');
        $("#duedate").val(''); 
        $("#issue-subject").val(''); 
